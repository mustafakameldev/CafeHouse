...
public class LocateCafe extends AppCompatActivity
    ...
    private static final    String TAG = LocateCafe.class.getSimpleName();
    ...
    public static Intent makeNotificationIntent(Context context, String msg) {
        Intent intent = new Intent( context, LocateCafe.class );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.locate_cafe);
        textLat = findViewById(R.id.lat);
        textLong = findViewById(R.id.lon);
        //search bar
        placeAutoComplete = (PlaceAutocompleteFragment) getFragmentManager().findFragmentById(R.id.place_autocomplete_powered_by_google);
            ...
            public void onPlaceSelected(Place place) {
               ...
               // onLocationChanged(newLoc);
                ...
                CameraPosition cameraPosition = new CameraPosition.Builder()
                        .target(new LatLng(newLoc.getLatitude(), newLoc.getLongitude())).zoom(15).build();
    ...
    private final int UPDATE_INTERVAL =  1*60*1000; //1 min
    private final int FASTEST_INTERVAL = 30*1000;   //30 sec
    ...
    private static final String GEOFENCE_REQ_ID = "My cafe";
